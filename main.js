...
function box2Scroll() {
    ...
    for(var i=0; i < animadoBox2.length; i++ ) {
        ...
        if(alturaAnimadoBox2 - 750 < scrollTop) {
            animadoBox2[i].className = "col-md-4 mt-3 mt-md-5 animate__animated animate__backInUp";
        }
    }
}
...
function box1Scroll() {
    ...
    for(var i=0; i < animadoBox1.length; i++ ) {
        ...
        if(alturaAnimadoBox1 - 750 < scrollTop) {
            animadoBox1[i].className = "row mx-auto mt-md-5 animate__animated animate__backInLeft";
        }
    }
}
...
function box3Scroll() {
    ...
    for(var i=0; i < animadoBox3.length; i++ ) {
        ...
        if(alturaAnimadoBox3 - 750 < scrollTop) {
            animadoBox3[i].className = "animate__animated animate__backInLeft";
        }
    }
}
